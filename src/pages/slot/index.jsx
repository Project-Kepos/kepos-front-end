  ...
  return (
    <>
      ...
      <div className={styles.description}>
        ...
        <div>
          Lorem ipsum dolor sit amet consectetur. Auctor ultrices molestie diam
          pellentesque ipsum pellentesque viverra arcu duis. Duis quam in
          gravida morbi adipiscing scelerisque cursus bibendum.
        </div>
      </div>
    </>
  )
